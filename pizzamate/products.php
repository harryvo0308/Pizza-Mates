...
<!--===============================================================================================-->
				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50" id="searchresultdata">
					<!--  -->
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								...
								<div class="block2-txt p-t-20">
									<a href="product-detail.php?product_id=<?php echo $row["C_ID"];?>" class="block2-name dis-block s-text3 p-b-5">
										<?php echo $row["C_Name"];?>
									</a>
